# Автотесты для сайта Ростелеком ID RTit (дипломный проект)
...
1. Клонировать репозиторий:
   ```bash
   git clone https://github.com/katifreedom1301-creator/RTit_Smirnova_236.git

## Структура проекта
- `tests/` - директория с тестами
- `tests/screenshots/` - скриншоты выполнения тестов
